            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {Array.isArray(post.tags) ? (
                  post.tags.map((tag) => (
                    <span key={tag} className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 px-2 py-1 rounded-full text-sm">
                      {tag}
                    </span>
                  ))
                ) : (
                  <span className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 px-2 py-1 rounded-full text-sm">
                    {post.tags}
                  </span>
                )}
              </div>
